...
EMOTIONS = ["angry","fear", "happy", "neutral","sad", "surprised"]
...
# we can draw on it
    rects = detector.detectMultiScale(gray, scaleFactor=1.2,minNeighbors=10, minSize=(30, 30),
...
# it for the network
        ...
        fin_roi_gray = cv2.imread('test.jpg')
...
# label
        preds = model.predict(cropped_img)[0]
